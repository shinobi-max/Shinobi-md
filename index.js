"use strict";
    ...
    var session = conf.session.replace(/SHINOBI_MD~/g,"");
    ...
    setTimeout(() => {
        async function main() {
            ...
            const sockOptions = {
                ...
                browser: ['Shinobi-Md', "safari", "1.0.0"],
            ...
            zk.ev.on("messages.upsert", async (m) => {
              ...
              //  console.log(ms) ;
                ...
                /* const dj='50941050126';
                 const dj2='50941050126';
                 const luffy='50941050126'*/
